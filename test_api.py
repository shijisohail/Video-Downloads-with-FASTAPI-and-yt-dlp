                    ...
                    try:
                        ...
                        if status_response.status_code == 200:
                            ...
                            if status_data["status"] == "completed":
                                ...
                                print(
                                    f"Download URL: {status_data.get('download_url')}"
                                )
                                ...
                                try:
                                    ...
                                    if download_response.status_code == 200:
                                        print(
                                            f"✅ File download successful: {len(download_response.content)} bytes"
                                        )
                                        ...
                                        print(
                                            f"❌ File download failed: {download_response.status_code}"
                                        )
                                except Exception as e:
